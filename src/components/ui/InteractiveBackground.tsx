...
export function InteractiveBackground() {
  ...
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 h-[115vh] opacity-100 [mask-image:linear-gradient(to_bottom,black_0%,black_82%,transparent_100%)] sm:[mask-image:linear-gradient(to_bottom,black_0%,black_58%,transparent_100%)]">
        <DottedSurface />
      </div>
      <motion.div
        ref={spotlightRef}
      ...
      />
      <div className="absolute inset-0 z-20 bg-[radial-gradient(circle_at_center,transparent_32%,rgba(0,0,0,0.58)_100%)] sm:bg-[radial-gradient(circle_at_center,transparent_15%,rgba(0,0,0,0.78)_100%)]" />
